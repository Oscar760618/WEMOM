...
class TextVAE(nn.Module):
    def __init__(self, vocab_size, embed_size, hidden_size, num_layers, dropout, num_labels=4):
        ...
        # Classifier only sees the latent Z (hidden_size), not the decoder outputs
        self.classifier = nn.Linear(hidden_size, num_labels)
        # self.decoder_projection is no longer needed for classification shortcut
    ...
    def forward(self, text):
        ...
        # Remove the shortcut! Force Z to carry sentiment info.
        # We don't need decoder features for classification anymore.
