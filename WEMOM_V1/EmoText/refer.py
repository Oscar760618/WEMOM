...
checkpoint_path = 'D:/Projects/URIS/URIS/WEMOM_V1/EmoText/params/TextVAE_latest.pt'
...
def make_latent_feature():
    ...
    np.save('D:/Projects/URIS/URIS/WEMOM_V1/Data/All_Data/text_features.npy', all_z)
    print("Latent space z shape:", all_z.shape)
    print("Saved as text_features.npy")
