...
checkpoint_path = 'D:/Projects/URIS/URIS/WEMOM_V1/EmoText/params/TextVAE_epoch_50.pt'
save_path = 'D:/Projects/URIS/URIS/WEMOM_V1/Data/All_Data/'
...
def make_latent_feature(sentence):
    ...
    np.save(f"{save_path}/test_single_text.npy", z)
    print("Latent space z shape:", z.shape)
    print(f"Saved as {save_path}/test_single_text.npy")

if __name__ == "__main__":
    sample_sentence = "I feel very happy."
